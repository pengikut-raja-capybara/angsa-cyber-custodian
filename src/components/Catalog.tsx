      ...
      <div className="container mx-auto px-4">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-gray-500 font-mono text-sm tracking-widest uppercase">Initializing Service Registry...</p>
          </div>
        ) : (
              ...
              <div key={category.id} className="relative reveal-on-scroll">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                  <div className="max-w-2xl">
                    <div className="inline-block px-3 py-1 bg-white/5 border border-white/10 text-[10px] tracking-[0.2em] uppercase text-gray-400 mb-4">Category: {category.title}</div>
                    <div className="flex items-center gap-3 mb-4">
                      <div style={{ color: getCategoryColor(category.id) }}>{getCategoryIcon(category.id)}</div>
